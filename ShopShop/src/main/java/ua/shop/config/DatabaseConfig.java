...
@EnableJpaRepositories(basePackages = "ua.shop.repository")
@ComponentScan(basePackages = {"ua.shop.service", "ua.shop.service.impl", "ua.shop.entity"})
...
public class DatabaseConfig {
	...
	public LocalContainerEntityManagerFactoryBean getEntityManagerFactory() throws PropertyVetoException {
		...
		emf.setPackagesToScan(new String[] {"ua.shop.entity"});
